...
import AutoSetupPanel from '@/components/dashboard/AutoSetupPanel';
...
export default function Dashboard() {
  ...
  // Tabs Configuration
  const tabs = [
    { id: 'setup', label: 'Otomatik Kurulum', icon: Icons.Settings },
  ...
  return (
    <div className="min-h-screen bg-gray-50 text-gray-800 font-sans pb-20">
      ...
      <main className="max-w-7xl mx-auto px-4 py-8">
        ...
        {/* SETUP TAB (Auto Setup) */}
        {activeTab === 'setup' && <AutoSetupPanel />}
